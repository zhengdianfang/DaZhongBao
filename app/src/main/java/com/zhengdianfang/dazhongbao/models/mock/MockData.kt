...
val mockToken = "c1ltzCjfhwO6_Xe_jJRkeQ=="
...
, mybids = mockBidList, csm_user = null)
...
val mockUserProducts = mutableListOf(
        Product(id = 5, sharesCode = "002739", basicUnitPrice = 23.09, soldCount = 3000000, limitTime = 6, industry = "汽车",
                ...
                companyName = "" , lastUnitPrice = 29.01, deal = mockDealList, nowUnitPrice = 22.19, startDateTime = 0, endDateTime = 0, mybids = mutableListOf(), csm_user = null),
        Product(id = 6, sharesCode = "000045", basicUnitPrice = 24.01, soldCount = 1000000, limitTime = 6, industry = "金融业",
                ...
                companyName = "" , lastUnitPrice = 39.01, deal = mockDealList, nowUnitPrice = 43.19,startDateTime = 0 ,endDateTime = 0, mybids = mutableListOf(), csm_user = null),
        Product(id = 7, sharesCode = "000046", basicUnitPrice = 26.00, soldCount = 4110000, limitTime = 6, industry = "金融业",
                ...
                companyName = "" , lastUnitPrice = 19.01, deal = mockDealList, nowUnitPrice = 23.19, startDateTime = 0, endDateTime = 0, mybids = mutableListOf(), csm_user = null),
        Product(id = 8, sharesCode = "000047", basicUnitPrice = 21.40, soldCount = 2110000, limitTime = 6, industry = "金融业",
                ...
                companyName = "" , lastUnitPrice = 19.01, deal = mockDealList, nowUnitPrice = 23.19, startDateTime = System.currentTimeMillis() + 2 *
                1000 * 24 * 3600, endDateTime = 0, mybids = mutableListOf(), csm_user = null),
        Product(id = 9, sharesCode = "000048", basicUnitPrice = 21.40, soldCount = 2110000, limitTime = 6, industry = "金融业",
                ...
                companyName = "" , lastUnitPrice = 19.01, deal = mockDealList, nowUnitPrice = 23.19, startDateTime = 0, endDateTime = System.currentTimeMillis() + 1000 * 24 * 3600, mybids = mockBidList, csm_user = null),
        Product(id = 10, sharesCode = "000049", basicUnitPrice = 21.40, soldCount = 2110000, limitTime = 6, industry = "金融业",
                ...
                companyName = "" , lastUnitPrice = 19.01, deal = mockDealList, nowUnitPrice = 23.19, startDateTime = System.currentTimeMillis() + 1000 * 24 * 3600, endDateTime = 0, mybids = mutableListOf(), csm_user = null),
